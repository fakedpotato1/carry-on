...
export default function EvidencePack() {
  ...
  return (
    <div className="page">
      <PageHeader eyebrow="Factual record" title="Evidence pack" description="A scannable history of what the team agreed, what occurred, and how recovery was attempted—without assigning intent or blame." actions={<Button icon={Download} onClick={() => setExported(true)}>Export signed PDF</Button>} />
      ...
      {exported && <div className="toast" role="status"><Check size={18} />Signed PDF prepared</div>}
    </div>
  )
}
