...
export default function LecturerEmail() {
  ...
  return (
    <div className="page"><div className="page-narrow">
      <PageHeader eyebrow="Review before sharing" title="Lecturer email draft" description="Carry On can prepare neutral wording, but it cannot send this message. Your team must edit, review, and copy or export it manually." />
